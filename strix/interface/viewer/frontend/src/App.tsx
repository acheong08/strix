...
export default function App() {
  ...
  const openEmailFromOverview = useCallback(() => userSetView("email"), [userSetView]);
    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="max-w-[88rem] mx-auto px-3 sm:px-6 py-8 sm:py-12 space-y-6">
          ...
          >
            {view === "email" ? (
              <EmailReportView activeRun={activeRun} onExit={() => setView("overview")} />
            ) : view === "feedback" ? (
              <FeedbackView
                defaultEmail={null}
...
/** Primary local CTA: build and download the PDF on this machine. */
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-white">Download a PDF report of this run</p>
          <p className="mt-0.5 text-xs text-[#888]">
            Generate the full report locally and save it directly to this machine.
          </p>
        </div>
...
function OverviewTab({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Primary CTA: hidden until the run is finished, since a live scan would
          only export a partial report. */}
      {finished && (
        <div className="animate-card-in">
