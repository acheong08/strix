...
- **History** — browse past runs on this machine and move between them from the same local viewer.
- **Reports** — generate and download a PDF locally, without a cloud account or email verification.
